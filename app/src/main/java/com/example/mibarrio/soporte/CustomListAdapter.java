...
public class CustomListAdapter extends ArrayAdapter<ListViewItem> {
    ...
    public CustomListAdapter(@NonNull Context context, int resource, @NonNull ArrayList<ListViewItem> objects, Accion<Integer> onClick) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        imagen.setImageBitmap(items.get(position).GetImagen());
